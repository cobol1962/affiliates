...
function ReconnectingWebSocket(version) {
    ...
    var url = "costercatalog.com:4000/?custid=" + u.EmplID + "&version=" + version;
    ...
    this.onopen = function () {
        ...
        url = ('https:' == document.location.protocol ? 'wss://' : 'ws://') + "costercatalog.com:4000/?custid=" + u.EmplID + "&version=" + version;
    ...
    this.onmessage = function (e) {
      ...
      if (obj.action == "reloadadmin") {
        refreshTables();
      }
      if (obj.action == "apperror") {
        showModal({
          type: "error",
          title: obj.text
